            ...
            pub mod nexmark {
                ...
                macro_rules! __export_pkg_component_nexmark_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        #[export_name = "pkg:component/nexmark#e1"] unsafe extern "C" fn
                        export_e1(arg0 : i64,) -> i32 { $($path_to_types)*::
                        _export_e1_cabi::<$ty > (arg0) } };
                    };
                }
                #[doc(hidden)]
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1979] = *b"\
...
oin-output\x02\x03\0\x04\x06q7-bid\x01BB\x02\x03\x02\x01\x06\x04\0\x03bid\x03\0\0\
...
\x01v.\0\x11\x04\0\x02q7\x01/\x01@\x01\x05pricew\0\x7f\x04\0\x02e1\x010\x04\0\x15\
pkg:component/nexmark\x05\x0f\x04\0\x17pkg:component/component\x04\0\x0b\x0f\x01\
