...
cargo r --release --manifest-path=host/Cargo.toml -- nexmark-data/bidComponent100_usedonly e2 10 5 ./host/
cargo r --release --manifest-path=host/Cargo.toml -- nexmark-data/bidComponent10000_usedonly e2 10 5 ./host/
cargo r --release --manifest-path=host/Cargo.toml -- nexmark-data/bid e3 10 5 ./host/
cargo r --release --manifest-path=host/Cargo.toml -- nexmark-data/bidComponent100_usedonly e4 10 5 ./host/